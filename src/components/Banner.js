...
const Banner = () => {
    ...
    const descriptionEllipsis = (string, numberOfString)=>{
        return string?.length > numberOfString ? string.substr(0, numberOfString-1)+ '...' : string //it takes a substring from 0 to n-1 and appends ... to it
    }
    ...
    <header className="bg-banner bg-cover bg-center h-[448px] relative text-white object-contain">
      <div className="ml-[30px] pt-[140px]">
        ...
        <h1 className="w-[720px] pt-[16px] text-[15px] max-w-[360px] h-[80px]">
          {descriptionEllipsis(`This is a movie description Lorem ipsum dolor sit amet consectetur
